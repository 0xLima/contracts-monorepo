 ...
 * @dev Main point of interaction with the Zapster Protocol's market
 * - Users can:
    ...
    Pausable
{
    ...
    // @dev for convienency this address is used to represent BSC Native Address
